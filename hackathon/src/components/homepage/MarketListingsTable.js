  ...
  return (
    <>
      ...
      >
        ...
        <Modal.Body>
          <p>
            <b>Posted by: {item.user} </b>
          </p>
          <p>
            <b>Quantity: {item.quantity} </b>
          </p>
          <p>
            <b>Description: </b> <span>{item.itemDescription}</span>
          </p>
          <p>
            <b>Location: </b> <span>{item.location}</span>
          </p>
          <p>
            <b>Time:</b> <span>{item.time}</span>
          </p>
        </Modal.Body>
        <Modal.Footer>
          <Button
          ...
          <Button
            className="take-it-modal-button"
            variant="none"
            onClick={(_) => {
              handleClose();
              onTaken(idx);
